...
public class BatallaPersonatjes_FrancoStival {
    ...
    public static void main(String[] args) {
        ...
        int probabilidadCritico1, probabilidadEsquiva1;
        String nom1, nom2;
        ...
        do {
            ...
            switch (cambioTurno) {
                case 0:
                    ...
                    probabilidadCritico1 = random.nextInt(100) + 1;
                    probabilidadEsquiva1 = random.nextInt(100) + 1;
                    if (probabilidadEsquiva1 <= 5) {
                        System.out.println(nom1 + " intenta atacar a " + nom2);
                        System.out.println("Pero " + nom2 + " esquiva el ataque.");
                    } else {
                        if (probabilidadCritico1 <= 10) {
                            dañoAtaque1 *= 2;
                            System.out.println(nom1 + " hace un golpe crítico!");
                        }
                        vida2 -= dañoAtaque1;
                ...
                case 1:
                    ...
                    probabilidadEsquiva1 = random.nextInt(100) + 1;
                    if (probabilidadEsquiva1 <= 5) {
                        System.out.println(nom1 + " esquiva el ataque.");
                    } else {
                        if (probabilidadCritico1 <= 10) {
                            dañoAtaque2 *= 2;
                            System.out.println(nom2 + " hace un golpe crítico!");
                        }
                        vida1 -= dañoAtaque2;
